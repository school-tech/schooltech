...
if(isset($_POST['submit'])){
    ...
    $data = mysqli_query($sql_con,"select * from schooladmin where emailaddress='$emailaddress' and password='$password'");
    ...
    if ($datarow > 0) {
      ...
      if($status == "Active"){
          ...
          echo "<script>alert('Your account has not been activated. Please contact RBTC Admin!')</script>";
...
<h3 class="account-subtitle">Welcome to the School Admin Panel</h3>
